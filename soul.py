...
bot = telebot.TeleBot('8087400158:AAHBjbxCU6ebvuqZjNZnSlSdDshfwFNZPAw')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "Mood ni hai abhi pelhe purchase kar isse:- @TREXVIVEK @SomsPvtt."
...
 Usage: /remove <userid>'''
        ...
        response = "Purchase karle bsdk:- @TREXVIVEK @SomsPvtt ."
...
Buy From :- @TREXVIVEK @SomsPvtt
Official Channel :- https://t.me/+kB41NmIXYBk3OGNl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+kB41NmIXYBk3OGNl OTHERWISE NOT WORK
